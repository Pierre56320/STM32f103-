...
#if NUCLEO
	#define BUZZER	GPIOB, GPIO_PIN_6
	#define BUTTON_1	GPIOB, GPIO_PIN_13
	#define BUTTON_2	GPIOB, GPIO_PIN_14
	#define BUTTON_3	GPIOB, GPIO_PIN_15
	#define BUTTON_4	GPIOB, GPIO_PIN_12
	#if BLUEPILL
...
#if BLUEPILL
	#define BUZZER	GPIOB, GPIO_PIN_6
	#define BUTTON_4	GPIOB, GPIO_PIN_13
	#define BUTTON_3	GPIOB, GPIO_PIN_14
	#define BUTTON_2	GPIOB, GPIO_PIN_15
	#define BUTTON_1	GPIOB, GPIO_PIN_12		//Pas de bouton sur la bluepill, choisissez le port souhaité si vous en reliez un.
#endif
